...
import GoBackStyled from "../components/GoBackStyled";
    ...
    render() {
        return (
            <View style={[ThemeStyles.applicationBackground, ThemeStyles.container]}>
                <GoBackStyled onPress={() => this.props.navigation.navigate('Administration')}
                              label={this.props.route.params.item.name} style={{}}
                              styleLabel={{fontSize: 18, top: -26}}/>
                <ScrollView>
