        ...
        <View style={{flex: 1,
            ...
            <View style={{ flex: 1,
                ...
                {props.images.map((image:any) => {
                    return (<TouchableOpacity onPress={() => props.navigation.navigate('DetailChildPhoto',{title: props.date,image: image})} style={[{
                        flexDirection: 'row',
                        borderRadius: 10,
                        margin: '2%',
                        width: '46%',
                ...
                {props.first ? <TouchableOpacity  style={[ThemeStyles.imageDashboard,{     alignItems: 'center',
...
export default class ChildPhotos extends Component<{ navigation: any }, ChildPhotosState> {
    ...
    render() {
        return (
            <View style={[ThemeStyles.applicationBackground,ThemeStyles.container]}>
                <GoBack onPress={() => this.props.navigation.navigate('MenuChild')} label={'Fotky'} style={{}}/>
                <ScrollView>
                    <View style={{ flex: 1,
                        flexDirection: 'column',
                        width: '100%',
