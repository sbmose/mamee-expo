...
export default class WeightAdd extends Component<{ navigation: any }> {
    ...
    render() {
        return (
            <View style={[ThemeStyles.applicationBackground, ThemeStyles.container]}>
                <ConfirmCancelNavigation onCancel={() => this.props.navigation.navigate('Weight')} label={'Záznam váhy'}  cancelStyle={{fontSize: 14, color: Theme.pink}} finishStyle={{fontSize: 14, color: Theme.pink}} onFinish={this.onFinish} labelCancel={'Zrušiť'} labelFinish={'Hotovo'}/>
